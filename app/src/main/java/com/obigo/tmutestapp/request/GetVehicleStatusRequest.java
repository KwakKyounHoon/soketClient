...
public class GetVehicleStatusRequest extends NetworkRequest<String> {
    private static final String DETAIL_URL = "http://192.168.0.61:3000/vehiclestatus";

    String vehicleid = "";
    public GetVehicleStatusRequest(String vehicleid){
