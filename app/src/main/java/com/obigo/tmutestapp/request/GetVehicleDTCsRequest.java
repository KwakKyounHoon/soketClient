...
public class GetVehicleDTCsRequest extends NetworkRequest<String> {
    private static final String DETAIL_URL = "http://192.168.0.61:3000/vehicledtcs";

    String vehicleid = "";
    public GetVehicleDTCsRequest(String vehicleid){
        this.vehicleid = vehicleid;
    }

    public GetVehicleDTCsRequest(){
