...
public class LightRequest extends NetworkRequest<String> {
    private static final String DETAIL_URL = "http://192.168.0.61:3000/light";

    String vehicleid = "";
    public LightRequest(String vehicleid){
