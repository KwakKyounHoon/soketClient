...
public class DoorUnlockRequest extends NetworkRequest<String> {
    private static final String DETAIL_URL = "http://192.168.0.61:3000/doorunlock";

    String vehicleid = "";
    public DoorUnlockRequest(String vehicleid){
        this.vehicleid = vehicleid;
    }

    public DoorUnlockRequest(){
